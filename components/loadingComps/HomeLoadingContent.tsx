      ...
      <div className="mx-auto  max-w-[822px]">
        ...
        <div className=" flex w-[470px] justify-between rounded-lg border border-stone-300 bg-white px-5 py-4 dark:border-stone-700 dark:bg-[#1c1c1c]">
          {circles.map((index) => (
            <div
              key={index}
              className="h-14 w-14 animate-pulse rounded-full bg-[#ebebeb] dark:bg-[#313131]"
            />
          ))}
        </div>
        <div className="mt-6 w-[470px]  rounded-lg border border-stone-300 bg-white dark:border-stone-700 dark:bg-[#1c1c1c]">
          <div className="flex h-14 items-center">
            ...
            <div className="ml-5 h-5 w-[200px] animate-pulse rounded-lg bg-[#ebebeb] dark:bg-[#313131]" />
          </div>
