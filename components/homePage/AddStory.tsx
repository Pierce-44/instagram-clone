    ...
    <label htmlFor="photoFile">
      ...
      <div className="flex cursor-pointer flex-col items-center">
        <div className="relative">
          ...
          <div className="absolute top-[-2px] left-[-2px] z-0 h-[60px] w-[60px] rounded-full bg-gradient-to-tr from-[#ffee00] to-[#d300c8]" />
          <AddStorySVG />
        </div>
        <div className="relative mt-2 max-w-[74px] overflow-hidden text-xs">
          ...
          {checkLength.nameWidth === 74 ? (
            <div className="absolute top-0 right-0 bg-white pr-[5px]">
              <p>...</p>
            </div>
          ) : (
            ''
