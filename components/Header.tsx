...
function Header({ count }: any) {
  ...
  return (
    <div className="border-b border-stone-300 bg-white dark:border-stone-700 dark:bg-[#1c1c1c] ">
      <div className=" flex h-[60px] items-center justify-between px-[5px] sm:px-[20px] lg:justify-center ">
        ...
        <div className="relative flex items-center pl-[15px] lg:pl-[100px]">
          <svg
            aria-label="Home"
            className="cursor-pointer fill-[#262626] dark:fill-slate-100"
            height="24"
            role="img"
            viewBox="0 0 24 24"
            width="24"
          ...
          <div className="ml-[10px] h-[24px] w-[24px] sm:ml-[22px]">
            <img
